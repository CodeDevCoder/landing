    ...
    <>
      ...
      <div className="grid items-center justify-center h-screen max-w-5xl gap-6 mx-auto md:grid-cols-2 px-20">
        <div className="max-w-112.5 mt-20 md:mt-0">
          <h1 className="text-2xl leading-tight text-center md:text-left md:text-4xl md:mb-10 mt-10 mb-5">
            Mis{" "}
            <span className="text-(--bg-secondary) font-bold">Servicios.</span>
          </h1>
          <p className="mb-8 text-base text-gray-300 break-words sm:text-xl">
          ...
          <button className="px-3 py-2 rounded-lg bg-(--bg-secondary) hover:bg-[#481D7A] cursor-pointer font-semibold mb-5">
            Contacta conmigo
          </button>
        </div>
        {/* Slider */}
